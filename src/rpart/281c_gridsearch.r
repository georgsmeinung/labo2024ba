# Variación del experimento modificando la relación 
# entre minbucket y minsplit. Además varía cp
  ...
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
  	for (rel_minsplit in c(2,3,4,5,10,20,50,100)) { 
  		for (vcp in (-1, -0.9, -0.8, -0.7, -0.6, -0.5)) { 
		    ...
		    print(paste0("Generando modelo con parámetros: cp=",
		                 param_basicos$cp,", maxpeth=",
		                 param_basicos$maxdepth,", minsplit=",
		                 param_basicos$minsplit,", minbucket=",
		                 param_basicos$minbucket, colapse=""))
