# ktry07 - Corrida Compentencia Kaggle
# - CA=Ninguno
# - DR=rank_cero_fijo
# - FEHist lag1, lag2, tendencia1, tendencia2 SIN ratios
# - CN doble despues de FEHist y despues de RF (ratio=2, desvio=-2)
# - RF con feature_fraction_bynode  = 0.4
# - TS en 19 meses desde 201901 y undersampling=1.0
# - Submits de 10500L a 12500L de a 250L
# - FM qsemillas=10
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202008, 202007, 202004, 202003, 201912, 201911,201908, 201907,201904, 201903)


  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
    202012, 202011, 202010, 202009, 202006, 202005, 202002, 202001, 201910, 201909,201906, 201905,201902, 201901)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=2, desvio=-2)
