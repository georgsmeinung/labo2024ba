...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202006, 202005, 202002, 202001, 201910, 201909,201906, 201905,201902, 201901)
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  # la Bayesian Optimization con el semillerio dentro
  ht <- HT_tuning_semillerio(
    semillerio = 21, # semillerio dentro de la Bayesian Optim
    bo_iteraciones = 20  # iteraciones inteligentes
  )
