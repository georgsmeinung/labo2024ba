# ktry08 - Corrida Compentencia Kaggle
# - CA=Ninguno
# - DR=rank_cero_fijo
# - FEHist lag1, lag2, tendencia1, tendencia2 SIN ratios
# - CN doble despues de FEHist y despues de RF (ratio=1.5, desvio=0.5)
# - RF default
# - TS en 19 meses desde 201901 y undersampling=0.5 en training y final
# - Submits de 10500L a 12500L cada 250L
# - FM qsemillas=20
...
wf_septiembre <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=1.5, desvio=0.5)
