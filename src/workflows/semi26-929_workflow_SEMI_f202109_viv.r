...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007,
                                  ...
                                  201905, 201904)
  param_local$train$validation <- c(202106,202006,202004)
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=0.95, desvio=2.35)
  CN_canaritos_asesinos_base(ratio=0.7, desvio=1.3)
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    c(ht, ts9), # los inputs
    ranks = c(3,5,7), # 1 = el mejor de la bayesian optimization
    semillerio = 15,   # cantidad de semillas finales
    repeticiones_exp = 3 )
