# semi18 - Corrida Compentencia Kaggle
# - CA=Ninguno
# - DR=rank_simple
# - FEHist lag1, lag2, tendencia1, tendencia2 SIN ratios
# - CN doble despues de FEhist(ratio=0.95, desvio=2.35) y de RF (ratio=0.95, desvio=2.35)
# - RF:
#      num_iterations = 50,
#      num_leaves  = 12,
#      min_data_in_leaf = 2,
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    c(ht, ts9), # los inputs
    ranks = c(1:4), # 1 = el mejor de la bayesian optimization
